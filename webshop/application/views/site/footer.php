				    ...
				    <div class="footer-info">            
				      ...
				      <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				        <a href="" title=""><strong>DÀNH CHO NGƯỜI BÁN</strong></a>                
				          <li> <a href="#" title="">Mở shop trên website</a></li> 
		...
		<div class="row" id="footer">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
					<address>
					  <strong>    Shop Tour Du Lịch Online</strong><br>
					  <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Địa chỉ: Nông Trang - Việt Trì<br>
