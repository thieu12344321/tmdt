<div class="row" style="margin-top: 8px;height: 110px">
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 clearpadding">
				<a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>upload/logooo.jpg" alt="" class="img-responsive"></a>
			</div>
			  ...
			  <div class="container-fluid re-container-fluid">
			    ...
			    <div class="collapse navbar-collapse re-navbar-collapse" id="bs-example-navbar-collapse-1">
			      <ul class="nav navbar-nav">
			        ...
			        <li class="dropdown">
			          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Tour Du Lịch<span class="caret"></span></a>
